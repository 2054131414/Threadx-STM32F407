...
#define OPEN_LCDDISPLAY     0xAD/* ����ʾ */
#define CLOSE_LCDDISPLAY    0xAC/* ����ʾ */
#define CMD_ROWADDRH            0x70/* �и�λCMD */
#define CMD_ROWADDRL            0x60/* �е�λCMD */
#define CMD_COLADDRH            0x10/* �и�λCMD */
#define CMD_COLADDRL            0x00/* �е�λCMD */
